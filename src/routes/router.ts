...
export default function routes() {
   ...
   */
  router.post('/api/referral/admin/generate', verifyToken, generateInviteCode)
   ...
   *         description: Internal server error.
   */
  router.post('/api/point/admin/distributeXP', verifyToken, distributeXP)
   ...
   *         description: Internal server error.
   */
  router.post('/api/point/admin/setMultiplier', verifyToken, setMultiplier)
   ...
   *         description: Internal server error.
   */
  router.post('/api/referral/user/validate', validateInviteCode)
   ...
   *         description: Internal server error.
   */
  router.post('/api/referral/user/redeem', redeemInviteCode)
   ...
   *         description: Internal server error.
   */
  router.get('/api/referral/user/:account', getUserReferral)
   ...
   *         description: Internal server error.
   */
  router.get('/api/point/user/:account', getUserPoint)
}
